...
public class ModifyProductScreenController implements Initializable {
    ...
    public void cancelButtonPushed(ActionEvent event) throws IOException
    {
        ...
        alert.setTitle("Confirmation to Leave Modify Product Page");
        alert.setHeaderText("Warning you are about to leave the Modify Product page.");
        alert.setContentText("Are you sure you want to go back to the main screen? "
                + "\n" + "The product will not be updated and any changes will be lost.");
           ...
           double totalCost = 0.00;
            ...
            if (totalCost> pPrice){
               ...
               if (pInStock > pMax || pInStock < pMin){
                    ...
                    controller.updateProducts(controller.getProductIndex(oldProduct),newProduct);
   ...
   public ObservableList<Part>  getParts(ObservableList<Part> partList)
    ...
    invAmountField.setText(Integer.toString((product.getInStock())));
    priceField.setText(Double.toString((product.getPrice())));
    minAmountField.setText(Integer.toString((product.getMin())));
    maxAmountField.setText(Integer.toString((product.getMax())));
